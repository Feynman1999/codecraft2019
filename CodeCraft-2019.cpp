...
double LEFT_PENALTY=27;
double RIGHT_PENALTY=57;
int Lucky_number=1567;
int Cross_penalty_alpha = 50;
...
struct Cross
{
        ...
        double query_penalty(int t)
    {
        ...
        if(query_car_num(t)<=get_road_num()) return 0;
        double num=7*query_car_num(t)*get_road_num();
        return num;
        }
    }
